...
def mandani(valueSoilMoisture, valueTemperature, valueLight, valueHumidity):
    ...
    soilMoisture['baja'] = fuzz.trapmf(soilMoisture.universe, [0, 0, 30, 45])
    soilMoisture['optimo'] = fuzz.trimf(soilMoisture.universe, [40, 60, 70]) 
    soilMoisture['alta'] = fuzz.trapmf(soilMoisture.universe, [65, 75, 100, 100])
